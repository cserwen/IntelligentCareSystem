...
public interface OldPersonMapper {
    ...
    @Insert("insert into oldperson_info(ORG_ID, CLIENT_ID, username,password, gender,phone,id_card,birthday,checkin_date, checkout_date, imgset_dir," +
            ...
            "values(1,1,#{username}, #{password}, #{gender},#{phone},#{idCard},#{birthday}, #{checkInDate}, #{checkOutDate}, #{imgSetDir}," +
    ...
    @Update("update oldperson_info set username=#{username}, password=#{password}, gender=#{gender}, phone=#{phone}, id_card=#{idCard}," +
